...
class HealthStatsWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        // ⚡ Bolt: Offload average calculations to the database
        // Expected impact: ~4x faster execution and significantly lower memory usage
        // by avoiding hydration of eloquent models.
